 ...
 * standard IPP/1.1 keyword names, CUPS supports name values of the form "HH:MM"
 * and "HH:MM:SS" that specify a hold time.<br>
 * The hold time is in Greenwich Mean Time (GMT) and not in the local time zone.
 * If the specified time is less than the current time, the job is held until
 * the next day.
 *
 * @author bpusch
 */
